        ...
        <div className="flex items-center w-auto gap-5 md:gap-10 flex-col md:flex-row">
          ...
          <div className='flex gap-10 md:gap-5'>
            ...
            <Popover className="relative">
              ...
              <Popover.Panel className="absolute z-10 text-right -right-24 py-3">
                  ...
                  {products.length === 0 ?
                    ...
                    <>
                      ...
                      <div className='flex mx-2 my-2 gap-3 text-zinc-900 dark:text-white items-center'>
                        ...
                        <button className='text-zinc-900 ml-auto dark:text-white bg-green-600 px-2 py-1 rounded-md'>Valider panier</button>
                      </div>
                    </>
                  }
                </div>
